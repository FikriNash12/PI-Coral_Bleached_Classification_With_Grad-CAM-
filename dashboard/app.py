...
def page_metrics():
    ...
    <div class="info-box" style="border-left-color: #f59e0b; background: linear-gradient(135deg, #1f1505, #0a0f0d); border-top: 1px solid #453008; border-right: 1px solid #453008; border-bottom: 1px solid #453008;">
        ...
        <ul style="margin: 0; padding-left: 1.2rem; color: #a3b8a8; line-height: 1.7;">
            <li><b>Karakteristik Prediksi:</b> Akurasi data uji <b>85,51%</b> (Akurasi validasi 83,73%) dengan distribusi galat seimbang (198 <i>False Positives</i> vs 141 <i>False Negatives</i>).</li>
            <li><b>Sensitivitas Warna & Cahaya:</b> Model mengandalkan sinyal rona terang/putih. Rentan <i>False Positive</i> pada karang pucat alami / <i>overexposed</i>, dan rentan <i>False Negative</i> pada citra air keruh (<i>turbid</i>) atau gelap.</li>
            <li><b>Potensi Confounding Domain:</b> Terdapat perbedaan signifikan kecerahan (NOAA 105,3 vs CS 123,2) dan ketajaman (NOAA 274,5 vs CS 380,8) antar-sumber data yang berisiko menjadi jalan pintas klasifikasi.</li>
            <li><b>Rekomendasi Lanjutan:</b> Diperlukan augmentasi warna bawah air agresif, simulasi turbiditas, serta validasi terisolasi pada citra perairan berarus keruh.</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
